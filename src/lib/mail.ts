...
<body style="margin:0;padding:0;background:${IVORY};font-family:Helvetica,Arial,sans-serif;color:#1b1f24;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:${IVORY};padding:32px 16px;">
    <tr><td align="center">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff;border:1px solid #ebe6df;">
        ...
        <tr><td style="padding:24px 32px 32px;border-top:1px solid #ebe6df;color:#6b7280;font-size:12px;line-height:1.6;">
...
export const p = (text: string) =>
  `<p style="margin:0 0 16px;font-size:15px;line-height:1.7;color:#1b1f24;">${text}</p>`;

export const small = (text: string) =>
  `<p style="margin:0 0 12px;font-size:13px;line-height:1.6;color:#6b7280;">${text}</p>`;
