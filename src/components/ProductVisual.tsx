  ...
  return (
    ...
    >
      ...
      <g transform="translate(150 34)">
        <rect width="150" height="168" rx="5" fill="#1a1c1f" />
        <rect x="6" y="6" width="138" height="156" rx="2" fill="url(#bpasScreen)" />
        <rect x="18" y="20" width="62" height="4" fill="#c1874c" />
        <rect x="18" y="34" width="106" height="3" fill="#091320" opacity="0.25" />
        <rect x="18" y="43" width="94" height="3" fill="#091320" opacity="0.25" />
        <rect x="18" y="58" width="48" height="34" fill="#091320" opacity="0.09" />
        <rect x="74" y="58" width="48" height="34" fill="#c1874c" opacity="0.16" />
        <rect x="18" y="102" width="104" height="3" fill="#091320" opacity="0.22" />
        <rect x="18" y="111" width="86" height="3" fill="#091320" opacity="0.22" />
        <rect x="18" y="120" width="96" height="3" fill="#091320" opacity="0.22" />
        <rect x="18" y="136" width="52" height="10" fill="#c1874c" />
      </g>

      {/* Bound volume in front */}
      <g transform="translate(18 22)">
        <rect x="4" y="8" width="132" height="182" rx="3" fill="#091320" opacity="0.28" />
        <rect width="132" height="182" rx="3" fill="url(#bpasCover)" />
        <rect x="0" y="0" width="9" height="182" fill="#c1874c" opacity="0.85" />
        <g transform="translate(30 40)">
          <path d="M36 6 L66 60 H54 L36 27 L18 60 H6 L36 6 Z" fill="#c1874c" opacity="0.9" />
          <circle cx="19" cy="50" r="4" fill="#c1874c" />
        </g>
        <rect x="30" y="118" width="72" height="3" fill="#ffffff" opacity="0.85" />
        <rect x="30" y="128" width="52" height="2.5" fill="#c1874c" />
    ...
    >
      <defs>
        <linearGradient id="terPaper" x1="0" y1="0" x2="0.4" y2="1">
          <stop offset="0%" stopColor="#ffffff" />
          <stop offset="100%" stopColor="#ece5d9" />
        </linearGradient>
      </defs>

      {/* Tablet + stylus behind */}
      <g transform="translate(168 40)">
        <rect width="134" height="156" rx="5" fill="#1a1c1f" />
        <rect x="6" y="6" width="122" height="144" rx="2" fill="#ffffff" />
        <g stroke="#091320" strokeOpacity="0.35" strokeWidth="1.1" fill="none">
          <circle cx="67" cy="60" r="30" />
          <circle cx="67" cy="60" r="20" />
          <path d="M67 30v60M37 60h60M46 39l42 42M88 39L46 81" />
        </g>
        <path d="M52 108h30M46 118h42M56 128h22" stroke="#c1874c" strokeWidth="2" strokeLinecap="round" />
        <rect x="118" y="150" width="6" height="58" rx="3" transform="rotate(22 118 150)" fill="#c1874c" />
      </g>

      {/* Printed book in front */}
      <g transform="translate(16 26)">
        <rect x="5" y="9" width="150" height="176" rx="2" fill="#091320" opacity="0.16" />
        <rect width="150" height="176" rx="2" fill="url(#terPaper)" stroke="#ece5d9" />
        <rect x="0" y="0" width="150" height="7" fill="#c1874c" />
        <text
          x="75"
          y="42"
          textAnchor="middle"
        ...
        <g stroke="#091320" strokeOpacity="0.4" strokeWidth="1" fill="none">
