    ...
    <>
        ...
        <Container className="relative">
          <div className="grid items-center gap-12 py-16 sm:py-20 lg:grid-cols-[1.15fr_1fr] lg:gap-16 lg:py-24">
            <div>
              ...
              <p className="mt-4 font-heading text-lg italic leading-snug text-white/85">
      ...
      <Section tone="white">
        ...
        <ol className="grid gap-px border border-ivory-200 bg-ivory-200 sm:grid-cols-2 lg:grid-cols-4">
          {journey.map(({ step, body }, index) => (
            <li key={step} className="bg-white px-7 py-9">
      ...
      <Section tone="ivory" id="corporate">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <Card tone="white" className="flex flex-col p-8 sm:p-10">
            <IconCircle>
